...
const RULES = {
  ...
  'target-size': {
    ...
    why: 'A tap target is the clickable area of a button, link, or control. WCAG 2.2 asks for at least 24 by 24 CSS pixels so people with motor impairments, or anyone on a phone, can hit it without slipping onto a neighbour.',
    fixText: 'Make the clickable area at least 24 by 24 CSS pixels. Icon-only buttons are easier at 44 by 44.',
    fixCode: 'button { min-width: 24px; min-height: 24px; padding: 12px; }',
  },
  'text-size': {
    category: 'Text size',
    wcag: '1.4.4',
    title: 'Text is smaller than 12px',
    why: 'Type below 12 CSS pixels is hard to read at default zoom, especially for low vision users. WCAG 1.4.4 also requires text to remain readable when enlarged; starting from tiny type makes that worse.',
    fixText: 'Increase the font size to at least 12px. Body copy and form fields are easier to read at 16px.',
    fixCode: 'font-size: 16px;',
  },
  'meta-viewport': {
    category: 'No keyboard support',
